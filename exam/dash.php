...
<div class="row">
<div class="col-lg-6">
<span class="logo">LTConnect Examination System</span></div>
<?php
...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="#" class="log log1">'.$name.'</a>&nbsp;|&nbsp;</span>';
}?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="pull-right"> <a href="../teacher.php"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Homescreen</a></li>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Batch</b></td><td><b>Score</b></td></tr>';
$c=0;
...
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$name.'</td><td>'.$batch.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Email</b></td><td><b>Batch</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['fullname'];
    $email = $row['email'];
  ...
  $phone = $row['phone'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$email.'</td><td>'.$batch.'</td><td>'.$phone.'</td>
